...
!(function (e, t) {
    ...
    function r(e, o) {
        ...
        else for (t = 0; t < r; t++) (callback_params = n), callback_params.splice(0, 0, e[t]), i.push(o.apply(this, callback_params));
        return i;
    }
    function s(e) {
        ...
        a = function (e, t) {
            for (var o, n, i, r, s = 0; s < e.length; s++)
                e[s] instanceof google.maps.LatLng ||
                    (0 < e[s].length && "object" == typeof e[s][0] ? (e[s] = a(e[s], t)) : (e[s] = ((o = e[s]), (n = t), (r = i = void 0), (i = o[0]), (r = o[1]), n && ((i = o[1]), (r = o[0])), new google.maps.LatLng(i, r))));
            return e;
        },
        p =
            ((C = document),
                (O = function (o) {
                    ...
                    var e,
                        ...
                        t = {
                            panControl: m,
                            zoomControl: c,
                            zoomControlOptions: { style: google.maps.ZoomControlStyle[u], position: google.maps.ControlPosition[d] },
                            mapTypeControl: f,
                            scaleControl: g,
                            streetViewControl: t,
                    ...
                    for (
                        ...
                        this.el.style.width = o.width || this.el.scrollWidth || this.el.offsetWidth,
                    ...
                    (this.buildContextMenu = function (o, n) {
                        ...
                        (this.setContextMenu = function (e) {
                            ...
                            for (t in e.options) e.options.hasOwnProperty(t) && ((o = e.options[t]), (window.context_menu[h.el.id][e.control][o.name] = { title: o.title, action: o.action }));
                    ...
                    google.maps.event.addListener(this.map, "rightclick", function (e) {
                        o.rightclick && o.rightclick.apply(this, [e]), null != window.context_menu[h.el.id].map && h.buildContextMenu("map", e);
                    }),
                        (this.refresh = function () {
                            google.maps.event.trigger(this.map, "resize");
                        }),
                        (this.fitZoom = function () {
                            for (var e = [], t = this.markers.length, o = 0; o < t; o++) "boolean" == typeof this.markers[o].visible && this.markers[o].visible && e.push(this.markers[o].getPosition());
                    ...
                    var b,
                        _ = [];
                    for (b in this.map) "function" != typeof this.map[b] || this[b] || _.push(b);
    ...
    return (
        (p.prototype.createControl = function (t) {
            ...
            for (e in ((n.style.cursor = "pointer"),
                !0 !== t.disableDefaultStyles && ((n.style.fontFamily = "Roboto, Arial, sans-serif"), (n.style.fontSize = "11px"), (n.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px")),
                t.style))
                n.style[e] = t.style[e];
            for (o in (t.id && (n.id = t.id),
                t.title && (n.title = t.title),
                t.classes && (n.className = t.classes),
                t.content && ("string" == typeof t.content ? (n.innerHTML = t.content) : t.content instanceof HTMLElement && n.appendChild(t.content)),
                t.position && (n.position = google.maps.ControlPosition[t.position.toUpperCase()]),
                t.events))
                !(function (e) {
        ...
        (p.prototype.createMarker = function (n) {
            ...
            if (((s.fences = o), n.infoWindow)) {
                ...
                for (var a = ["closeclick", "content_changed", "domready", "position_changed", "zindex_changed"], l = 0; l < a.length; l++)
                    !(function (e, t) {
                        n.infoWindow[t] &&
                            google.maps.event.addListener(e, t, function (e) {
        ...
        (p.prototype.removeMarkers = function (e) {
            var t = [];
            if (void 0 === e) {
                for (var o = 0; o < this.markers.length; o++) (i = this.markers[o]).setMap(null), p.fire("marker_removed", i, this);
                ...
                for (o = 0; o < e.length; o++) {
                    ...
                    -1 < n && ((i = this.markers[n]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(i), p.fire("marker_removed", i, this));
                }
        ...
        (p.prototype.drawPolyline = function (o) {
            ...
            if (t.length)
                if (void 0 === t[0][0]) e = t;
                else for (var n, i = 0; (n = t[i]); i++) e.push(new google.maps.LatLng(n[0], n[1]));
            var r = { map: this.map, path: e, strokeColor: o.strokeColor, strokeOpacity: o.strokeOpacity, strokeWeight: o.strokeWeight, geodesic: o.geodesic, clickable: !0, editable: !1, visible: !0 };
            ...
            for (var s = new google.maps.Polyline(r), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], l = 0; l < a.length; l++)
                !(function (t) {
                    o[t] &&
        ...
        (p.prototype.drawCircle = function (o) {
            delete (o = M({ map: this.map, center: new google.maps.LatLng(o.lat, o.lng) }, o)).lat, delete o.lng;
            for (var e = new google.maps.Circle(o), t = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], n = 0; n < t.length; n++)
                !(function (t) {
                    o[t] &&
                        google.maps.event.addListener(e, t, function (e) {
                            o[t].apply(this, [e]);
        ...
        (p.prototype.drawRectangle = function (o) {
            ...
            o.bounds = e;
            for (var n = new google.maps.Rectangle(o), t = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < t.length; i++)
                !(function (t) {
                    o[t] &&
        ...
        (p.prototype.drawPolygon = function (o) {
            var e = !1;
            o.hasOwnProperty("useGeoJSON") && (e = o.useGeoJSON), delete o.useGeoJSON, (o = M({ map: this.map }, o)), 0 == e && (o.paths = [o.paths.slice(0)]), 0 < o.paths.length && 0 < o.paths[0].length && (o.paths = s(r(o.paths, a, e)));
            for (var n = new google.maps.Polygon(o), t = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < t.length; i++)
                !(function (t) {
                    o[t] &&
                        google.maps.event.addListener(n, t, function (e) {
                            o[t].apply(this, [e]);
        ...
        (p.prototype.addLayer = function (e, t) {
            ...
            switch (((t = t || {}), e)) {
                ...
                case "panoramio":
                    ...
                    break;
                case "places":
                    (this.singleLayers.places = o = new google.maps.places.PlacesService(this.map)),
                        (t.search || t.nearbySearch || t.radarSearch) &&
                        ((n = { bounds: t.bounds || null, keyword: t.keyword || null, location: t.location || null, name: t.name || null, radius: t.radius || null, rankBy: t.rankBy || null, types: t.types || null }),
                            t.radarSearch && o.radarSearch(n, t.radarSearch),
                            t.search && o.search(n, t.search),
                            t.nearbySearch && o.nearbySearch(n, t.nearbySearch)),
                        t.textSearch && ((n = { bounds: t.bounds || null, location: t.location || null, query: t.query || null, radius: t.radius || null }), o.textSearch(n, t.textSearch));
            }
        ...
        (p.prototype.getRoutes = function (n) {
            ...
            var e = M({ avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: [] }, n);
        ...
        (p.prototype.getElevations = function (e) {
            0 < (e = M({ locations: [], path: !1, samples: 256 }, e)).locations.length && 0 < e.locations[0].length && (e.locations = s(r([e.locations], a, !1)));
            var o = e.callback;
            delete e.callback;
            var t,
        ...
        (p.prototype.drawRoute = function (o) {
            ...
            this.getRoutes({
                ...
                callback: function (e) {
                    var t;
                    0 < e.length &&
                        ((t = { path: e[e.length - 1].overview_path, strokeColor: o.strokeColor, strokeOpacity: o.strokeOpacity, strokeWeight: o.strokeWeight }),
                ...
                this.getRoutes({
                    ...
                    callback: function (e) {
                        if ((0 < e.length && r.start && r.start(e[e.length - 1]), 0 < e.length && r.step)) {
                            var t = e[e.length - 1];
                            if (0 < t.legs.length) for (var o, n = t.legs[0].steps, i = 0; (o = n[i]); i++) (o.step_number = i), r.step(o, t.legs[0].steps.length - 1);
                        }
                        0 < e.length && r.end && r.end(e[e.length - 1]);
                    },
                });
            else if (r.route && 0 < r.route.legs.length) for (var e, t = r.route.legs[0].steps, o = 0; (e = t[o]); o++) (e.step_number = o), r.step(e);
        }),
        (p.prototype.drawSteppedRoute = function (s) {
            ...
            if (s.origin && s.destination)
                        ...
                        if ((0 < e.length && s.start && s.start(e[e.length - 1]), 0 < e.length && s.step)) {
                            ...
                            if (0 < t.legs.length)
                                for (var o, n = t.legs[0].steps, i = 0; (o = n[i]); i++) {
                                    o.step_number = i;
                                    var r = { path: o.path, strokeColor: s.strokeColor, strokeOpacity: s.strokeOpacity, strokeWeight: s.strokeWeight };
                ...
                for (var e, t = s.route.legs[0].steps, o = 0; (e = t[o]); o++) {
                    e.step_number = o;
                    var n = { path: e.path, strokeColor: s.strokeColor, strokeOpacity: s.strokeOpacity, strokeWeight: s.strokeWeight };
        ...
        (p.prototype.toImage = function (e) {
            ...
            return (
                ...
                ((e = this.polylines[0]),
                    (t.polyline = {}),
                    (t.polyline.path = google.maps.geometry.encoding.encodePath(e.getPath())),
        ...
        (p.staticMapURL = function (e) {
            ...
            delete e.polyline,
                e.center
                    ...
                    : e.address
                        ...
                        : e.lat
                            ? (t.push(["center=", e.lat, ",", e.lng].join("")), delete e.lat, delete e.lng)
                            : e.visible && ((s = encodeURI(e.visible.join("|"))), t.push("visible=" + s));
            var s = e.size;
            ...
            if (n)
                for (var a, l, p = 0; (y = n[p]); p++) {
                    for (var c in ((a = []),
                        y.size && "normal" !== y.size ? (a.push("size:" + y.size), delete y.size) : y.icon && (a.push("icon:" + encodeURI(y.icon)), delete y.icon),
                        y.color && (a.push("color:" + y.color.replace("#", "0x")), delete y.color),
                        y.label && (a.push("label:" + y.label[0].toUpperCase()), delete y.label),
                    ...
                    a.length || 0 === p ? (a.push(l), (a = a.join("|")), t.push("markers=" + encodeURI(a))) : ((a = t.pop() + encodeURI("|" + l)), t.push(a));
                }
            if (i)
                for (p = 0; p < i.length; p++) {
                    var g = [];
                    i[p].featureType && g.push("feature:" + i[p].featureType.toLowerCase()), i[p].elementType && g.push("element:" + i[p].elementType.toLowerCase());
                    for (var h = 0; h < i[p].stylers.length; h++)
                        for (var u in i[p].stylers[h]) {
                            var d = i[p].stylers[h][u];
                            ("hue" != u && "color" != u) || (d = "0x" + d.substring(1)), g.push(u + ":" + d);
                        }
                    var m = g.join("|");
                    "" != m && t.push("style=" + m);
                }
            ...
            if (r) {
                ...
                y.strokeWeight && r.push("weight:" + parseInt(y.strokeWeight, 10)),
                    y.strokeColor && ((s = f(y.strokeColor, y.strokeOpacity)), r.push("color:" + s)),
                    y.fillColor && ((k = f(y.fillColor, y.fillOpacity)), r.push("fillcolor:" + k));
                var v = y.path;
        ...
        (p.createPanorama = function (t) {
            ...
            for (var o = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], n = M({ visible: !0 }, t), i = 0; i < o.length; i++) delete n[o[i]];
            for (var r = new google.maps.StreetViewPanorama(e, n), i = 0; i < o.length; i++)
                !(function (e) {
                    t[e] &&
        ...
        (p.fire = function (e, t, o) {
            ...
            else if (e in o.registered_events) for (var n = o.registered_events[e], i = 0; i < n.length; i++) n[i].handler.apply(o, [t]);
        }),
        ...
        (Array.prototype.indexOf = function (e) {
            ...
            for (var i = 0 <= n ? n : Math.max(o - Math.abs(n), 0); i < o; i++) if (i in t && t[i] === e) return i;
            return -1;
        }),
        p
    );
