            ...
            (n.prototype.toggle = function () {
                ...
                i.length
                    ? ("radio" == (t = this.$element.find("input")).prop("type")
                        ? (t.prop("checked") && (e = !1), i.find(".active").removeClass("active"), this.$element.addClass("active"))
            ...
            (o && 3 === o.which) ||
                (n(".dropdown-backdrop").remove(),
                    n(r).each(function () {
                        ...
                        e.hasClass("open") &&
                            ((o && "click" == o.type && /input|textarea/i.test(o.target.tagName) && n.contains(e[0], o.target)) ||
                                (e.trigger((o = n.Event("hide.bs.dropdown", i))), o.isDefaultPrevented() || (t.attr("aria-expanded", "false"), e.removeClass("open").trigger("hidden.bs.dropdown", i))));
                    }));
        }
        function o(t) {
        ...
        (h.VERSION = "3.3.5"),
                ...
                for (var o = this.options.trigger.split(" "), n = o.length; n--;) {
                    ...
                    "click" == a
                        ...
                        ((s = "hover" == a ? "mouseenter" : "focusin"),
                            ...
                            this.$element.on(s + "." + this.type, this.options.selector, l.proxy(this.enter, this)),
                    ...
                    (this.$element.trigger(r),
                        ...
                        ((t = (e = this).tip()),
                            ...
                            ((o = a),
                                ...
                                (a = "bottom" == a && r.bottom + s > n.bottom ? "top" : "top" == a && r.top - s < n.top ? "bottom" : "right" == a && r.right + i > n.width ? "left" : "left" == a && r.left - i < n.left ? "right" : a),
            ...
            (h.prototype.hide = function (t) {
                ...
                return (
                    ...
                    n.isDefaultPrevented() ? void 0 : (o.removeClass("in"), l.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", e).emulateTransitionEnd(h.TRANSITION_DURATION) : e(), (this.hoverState = null), this)
                );
            }),
            ...
            (h.prototype.getPosition = function (t) {
                ...
                (e = i ? { top: 0, left: 0 } : t.offset()), (t = { scroll: i ? document.documentElement.scrollTop || document.body.scrollTop : t.scrollTop() }), (i = i ? { width: l(window).width(), height: l(window).height() } : null);
            ...
            (h.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
                ...
                return (
                    /right|left/.test(t)
                        ? ((t = e.top - a - r.scroll), (s = e.top + a - r.scroll + o), t < r.top ? (n.top = r.top - t) : s > r.top + r.height && (n.top = r.top + r.height - s))
                        : ((s = e.left - a), (i = e.left + a + i), s < r.left ? (n.left = r.left - s) : i > r.right && (n.left = r.left + r.width - i)),
                    n
                );
            }),
